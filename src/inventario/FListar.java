...
public class FListar extends javax.swing.JFrame {
    ...
    public void listar(){
        int fil=0;
        try{
            int tamano=objManejadora.tamanoResultSet();
            ...
            resultado=st.executeQuery("select * from inventario"); // para filtrar select placa, modelo
            while(resultado.next()){
                ...
                jTable1.setValueAt(resultado.getString(4), fil, 3);
